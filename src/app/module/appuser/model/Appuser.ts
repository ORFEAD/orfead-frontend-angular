...
import { AppuserOrganizationAsso } from './AppuserOrganizationAsso';
...
export class Appuser extends EntityBase {
    ...
    allRoles:Role[];   
    organizationsAssos:AppuserOrganizationAsso[];
...
//        console.dir(_json);
        ...
        this.organizationsAssos = [];
        if (_json['organizationsAssos'] != null) {
            for (let e of _json['organizationsAssos']) {
                this.organizationsAssos.push(new AppuserOrganizationAsso(e));
            }
        }
